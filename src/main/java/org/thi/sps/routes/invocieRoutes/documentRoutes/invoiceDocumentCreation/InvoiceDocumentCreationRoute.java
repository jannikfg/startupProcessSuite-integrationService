package org.thi.sps.routes.invocieRoutes.documentRoutes.invoiceDocumentCreation;
...
public class InvoiceDocumentCreationRoute extends GenericSpiffworkflowRouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    // Erstelle einen benutzerdefinierten ObjectMapper
    ObjectMapper objectMapper = new ObjectMapper();
    objectMapper.registerModule(new JavaTimeModule());

    // Format für das Unmarshalling von Client-Daten
    ...
    // Format für das Marshalling des InvoiceCreationRequest-Objekts
